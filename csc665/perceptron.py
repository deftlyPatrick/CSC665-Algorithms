...
class Sequential:
	...
	def __init__(self, layers):
		...
		# print("weight[1]: ", layers[0].weights)
		# print("self.weights: ", layers[0].weights)

		# print("weights: ", layers[0].weights)
		# print("weights: ", layers[1].weights)
		# self.bias = layers[0].bias
		# self.temp1 = 0
		# print("entire_weights: ", entire_weights)
		# print("entire_bias: ", entire_bias)
	...
	def forward(self, x):
		...
		for i in range(len(self.layers)):
			...
			if i == len(self.layers)-1:
				pre_activation = (np.dot(a, weight) + bias)
			else:
				a_equ = (np.dot(x, weight)) + bias
				# print("a_equ1: ", a_equ)
				if a_equ > 0:
